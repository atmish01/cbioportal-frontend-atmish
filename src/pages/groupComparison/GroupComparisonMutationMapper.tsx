...
} from '../resultsView/querySummary/QuerySummaryUtils';
...
export interface IGroupComparisonMutationMapperProps
    extends IMutationMapperProps {
    store: GroupComparisonMutationMapperStore;
